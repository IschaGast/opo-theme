...
export const normal = [
  ...
  { mode: 'oklch', l: 0.5300, c: 0.1400, h: 80.00 },    // 3 yellow  — amber
  { mode: 'oklch', l: 0.3300, c: 0.1600, h: 258.00 },   // 4 blue    — blue (pass)
  { mode: 'oklch', l: 0.4000, c: 0.1200, h: 328.00 },   // 5 magenta — purple
...
export const bright = [
  ...
  { mode: 'oklch', l: 0.6000, c: 0.1600, h: 258.00 },   // 12 bright blue    — bright blue
